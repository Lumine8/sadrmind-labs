        ...
        <div className="container">
          <div style={{ marginBottom: "3rem" }}>
            ...
            >
              Intelligent systems,
              <br />
              <span>precisely crafted</span>
            </h2>

            <p className="section-body fade-up delay-2">
              Each product represents months of research and engineering — built
              to solve hard problems elegantly.
            </p>
          </div>
        ...
        <div className="container">
          <div className="about-preview">
            <div className="about-preview__text">
              ...
              <p className="section-body fade-up delay-2">
                We operate at the intersection of security, artificial intelligence,
                financial automation, and game technology — building systems that
                are not just functional, but genuinely intelligent.
              </p>
        ...
        <div className="container">
          <div className="cta-section__content">
            ...
            <p className="cta-section__desc fade-up delay-1">
              Dive into our products, read about our philosophy, or reach out
              directly to discuss collaboration.
            </p>
